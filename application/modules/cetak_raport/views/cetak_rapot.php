...
<body>
	<table>
		...
		<tbody>
		<tr>
			<td colspan="6" style="text-align: center; font-weight: bold"><p><h3>LAPORAN HASIL BELAJAR <br> PENILAIAN AKHIR SEMESTER (PAS)</h3></p></td>
		</tr>
		<tr>
		...
		<tr><td colspan="6">
			<table style="margin-left: 15px">
				...
				<tr><td></td><td style="border: solid 1px #000; padding: 10px"><?php echo $nilai_sikap_spiritual; ?></td></tr>
				<tr><td width="3%"><b>2.</b></td><td width="97%"><b>Sikap Sosial</b></td></tr>
				<tr><td></td><td style="border: solid 1px #000; padding: 10px"><?php echo $nilai_sikap_sosial; ?></td></tr>
			</table>
			<br>
		</td></tr>
		...
		<tr>
		    <td colspan="6">
		        ...
		        <div style="border: solid 1px; padding: 10px; margin-top: 40px">
            	    ...
            	    <div style="display: block">
                	    <div style="diplay: inline; float: left; width: 200px;<?=$tidak_naik;?>">tinggal di kelas </div>
        	    ...
        	    <div style="border: solid 1px; padding: 10px; margin-top: 40px">
            		<b>Keputusan : </b>
            	    <p>Berdasarkan pencapaian kompetensi pada kelas 4, 5 dan 6, maka, peserta didik dinyatakan : *) :<br>

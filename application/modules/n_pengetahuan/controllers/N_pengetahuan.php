        ...
        if (!empty($d_nilai)) {
            ...
            foreach ($d_nilai as $ke => $dn) {
                ...
                $html .= '<td class="ctr">'.$nilai_akhir_kd.'</td>
                    ...
                    '<td class="ctr">'.nilai_huruf($detil_guru['kkm'], $na_np).'</td><td class="ctr">'.$kkm.'</td><td> Ananda '.strtoupper($dn['nama']).', '.$kurang.$cukup.$baik.$sangat_baik.'</td>';

                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php echo form_dropdown('ssp1_'.$no,$opsyen,$pcs,'class="form-control" required id="ssp1_'.$no.'"'); ?>
                                </td>
                                <td>
                                    <?php echo form_dropdown('ssp2_'.$no,$opsyen,$pcs1,'class="form-control" required id="ssp2_'.$no.'"'); ?>
                                </td>
                                <td>

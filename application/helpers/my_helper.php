...
function generate_menu($level, $is_wali=false) {
	...
	if ($level == "admin") {
		...
		$menu .= $is_wali == TRUE ? '<li class="devider"></li>
		                            ...
		                            <li><a href="'.base_url().'cetak_raport_pts"><i class="pe-7s-print"></i><p>Cetak Raport PTS</p></a></li>
		                            <li><a href="'.base_url().'cetak_raport"><i class="pe-7s-print"></i><p>Cetak Raport PAS</p></a></li>

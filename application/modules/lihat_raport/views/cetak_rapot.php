...
<body>
	...
	<table>
		...
		<tr>
			<td width="20%">Nama SD</td><td width="1%">:</td><td width="39%" class="tbl">SDI DARUR ROHMAN</td>
			<td width="20%">Kelas</td><td width="1%">:</td><td width="19%" class="tbl"><?php echo strtoupper($wali_kelas['nama_kelas']); ?></td>
		</tr>
		<tr>
			<td>Alamat </td><td>:</td><td class="tbl">JL. Makam H. Nurrohman RT 04 RW 07 Kel. Banjardowo Kec. Genuk Kota Semarang.</td>
			...
			<td colspan="6">
				...
				<table width="100%">
					<tr>
						...
						<td width="10%"></td>
						<td width="30%">
							Kota Semarang, <?php echo $this->config->item('tgl_cetak'); ?><br>
							Kepala Sekolah <br>
							<br><br><br><br>
							<u><b>Ahmad Nurcholiq, S.H</b></u><br>
							NIP.-
						</td>
					</tr>
				</table>

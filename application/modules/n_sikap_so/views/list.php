                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                if (!empty($list_kd)) {
                                    foreach ($list_kd as $k) {
                                        ...
                                        if (in_array($k['id'], $pc_selalu)) {
                                            ...
                                            if($k['id'] == '1' || $k['id'] == '2' || $k['id'] == '3'){
                                                $ck = "checked";
                                            }else{
                                                $ck = "";
                                            }
                                            echo '<td class="text-center"><label class="nso"><input type="checkbox" name="selalu_'.$no.'[]" value="'.$k['id'].'"'.$ck.'></label></td>';
                                        }
                                    }
                                }
                                ?>
                                <td>
                                    <?php 
                                        if(empty($sk['mulai_meningkat'])){
                                            $sk = '4';
                                        }else{
                                            $sk = $sk['mulai_meningkat'];
                                        }

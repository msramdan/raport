    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <a href="<?php echo base_url(); ?>n_pengetahuan/cetak/<?php echo $detil_mp['id_mapel']."-".$detil_mp['id_kelas']; ?>" class="btn btn-warning" target="_blank"><i class="fa fa-print"></i> Cetak</a>

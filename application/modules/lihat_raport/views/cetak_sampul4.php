...
<body>
	<table>
		<tr>
			<td width="10%">
			<img src="<?php echo base_url(); ?>aset/img/logo_twh.png" style="margin-top: 10px; width: 90px; height: 80px">
			</td>
			<td style="text-align: center"><b>KEMENTERIAN AGAMA REPUBLIK INDONESIA<br>
			KANTOR KEMENTERIAN AGAMA KOTA SEMARANG<br>
			SDI DARUR ROHMAN<br></b>
			<span style="font-size: 10pt">Alamat : Jl. Makam H.Nurrohman RT04/RW07 Banjardowo, Genuk, Kota Semarang . <br>
			Telp : 08123456789 | Web : http://sdidarurrohman.sch.id/</span>
			</td>
		</tr>
		...
		<tr><td colspan="2">
			...
			<table width="100%">
				...
				<tr><td>12.</td><td>Ijazah </td><td>:</td><td></td></tr>
				<tr><td></td><td>a. Nomor</td><td>:</td><td><?php echo $ds['ijazah_no']; ?></td></tr>
				<tr><td></td><td>b. Tahun</td><td>:</td><td><?php echo $ds['ijazah_thn']; ?></td></tr>
				<tr><td>13.</td><td colspan="3">Surat Keterangan Hasil Ujian Akhir Sekolah Berstandar Nasional (UASBN)</td></tr>
	...
	<div style="margin-left: 120px; display: inline; float: left;">
		Kota Semarang, <?php echo tjs($ds['diterima_tgl'],"l"); ?><br>
		Kepala Sekolah<br>
		<br>
		<br>
		<br>
		<br>
		<b><u>Ahmad Nurcholiq, S.H</u></b><br>
		NIP.-
	</div>

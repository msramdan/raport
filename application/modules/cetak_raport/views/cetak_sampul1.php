...
<body>
	<center>
		...
		<span style="font-size: 14pt"><b style="font-size: 18pt">RAPORT PESERTA DIDIK<br>
		<?php echo strtoupper($this->config->item('jenis_sekolah')); ?>
		...
		<img src="<?php echo base_url(); ?>aset/img/<?=$this->config->item('logo_sekolah')?>" style="height: 166px;width: 177px;"><br>
		<br>
		<br>
		<br>
		...
		<b>DINAS PENDIDIKAN DAN KEBUDAYAAN<br>
		<?php echo strtoupper($this->config->item('kota')); ?>
		<br> TAHUN <?=date('Y')?></b>

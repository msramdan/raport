    ...
    public function cetak($id_siswa,$tasm) {
        ...
        foreach ($array1 as $k => $v) {
            ...
            foreach ($array1[$k]['h'] as $j) {
                ...
                $_desk = nilai_pre($pc_nilai_h[0],400);
            ...
            $nilai_pengetahuan[$k]['predikat'] = nilai_huruf($_np,400); 
        ...
        foreach ($array2 as $k => $v) {
            ...
            foreach ($array2[$k] as $j) {
                ...
                $_desk = nilai_pre($pc_nilai[0],400);
            ...
            $nilai_keterampilan[$k]['predikat'] = nilai_huruf($_nilai_keterampilan,400); 
        ...
        //foreach ($kelompok as $k) {
            ...
            foreach ($q_mapel as $i=>$m) {
                ...
                $npa = empty($nilai_pengetahuan[$idx]['nilai']) ? "-" : $nilai_pengetahuan[$idx]['nilai'];
                $npp = empty($nilai_pengetahuan[$idx]['predikat']) ? "-" : $nilai_pengetahuan[$idx]['predikat'];
                $npd = empty($nilai_pengetahuan[$idx]['desk']) ? "-" : "Capaian kompetensi sudah tuntas dengan predikat ".nilai_pre($npa,400).". ".$nilai_pengetahuan[$idx]['desk'];
                $nka = empty($nilai_keterampilan[$idx]['nilai']) ? "-" : $nilai_keterampilan[$idx]['nilai'];
                $nkp = empty($nilai_keterampilan[$idx]['predikat']) ? "-" : $nilai_keterampilan[$idx]['predikat'];
                    $nkd = empty($nilai_keterampilan[$idx]['desk']) ? "-" : "Capaian kompetensi sudah tuntas dengan predikat ".nilai_pre($nka,400).". ".$nilai_keterampilan[$idx]['desk'];

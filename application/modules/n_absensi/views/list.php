                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <input type="number" min="0" max="100" name="s_<?php echo $no; ?>" value="<?php echo $s ?>" class="form-control input-sm" required id="s_<?php echo $no; ?>">
                                </td>
                                <td>
                                    <input type="number" min="0" max="100" name="i_<?php echo $no; ?>" value="<?php echo $i; ?>" class="form-control input-sm" required id="i_<?php echo $no; ?>">
                                </td>
                                <td>
                                    <input type="number" min="0" max="100" name="a_<?php echo $no; ?>" value="<?php echo $a; ?>" class="form-control input-sm" required id="a_<?php echo $no; ?>">
                                </td>
                            </tr>
                        <?php 
                                $no++;

...
<head>
	...
	<title>E-Raport SDI Darur Rohman</title>
...
<body>
<div class="wrapper">
    <div class="sidebar" data-color="" data-image="<?php echo base_url(); ?>aset/img/">
    <!--
    	...
    	<div class="sidebar-wrapper" >
            <div class="logo">
                <a href="<?php echo base_url(); ?>" class="simple-text">
                    <i class="pe-7s-notebook"></i>E-Raport
                </a>
            </div>
        ...
        <nav class="navbar navbar-default navbar-fixed " >
            <div class="container-fluid">
                <div class="navbar-header ">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><i class="pe-7s-notebook"></i>E-Raport SDI Darur Rohman</a>
                </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    Waktu proses {elapsed_time} detik. &copy;<?=date('Y')?> SDI Darur Rohman
                </p>
            </div>
        </footer>
